        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-10 text-lg leading-8 text-white/80 sm:text-xl lg:text-2xl max-w-3xl mx-auto">
              Flowstack automatisiert dein Fulfillment komplett. Von der Strategie bis zur Live-Kampagne. Mehr Kunden, gleiche Teamgröße.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <button className="group relative overflow-hidden rounded-full inline-flex items-center justify-center font-semibold transition-all px-8 py-6 text-lg bg-white text-black hover:bg-gray-100 shadow-2xl shadow-white/25">
              ...
              <button className="group relative overflow-hidden rounded-full inline-flex items-center justify-center font-semibold transition-all px-8 py-6 text-lg border border-white/20 bg-transparent backdrop-blur-xl text-white hover:bg-white/10 hover:border-white/30">
                <span className="relative z-10 flex items-center">Mehr erfahren</span>
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-white/60 text-sm">Zeitersparnis</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-2">3x</div>
                <div className="text-white/60 text-sm">Mehr Kunden</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-2">24/7</div>
                <div className="text-white/60 text-sm">Automatisiert</div>
              </div>
            </div>
          </div>
        </div>
